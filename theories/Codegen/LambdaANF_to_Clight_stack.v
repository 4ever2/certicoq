...
Notation funTy := (Tfunction (cons threadInf nil) val cc_default).

Notation pfunTy := (Tpointer funTy noattr).

Notation gcTy := (Tfunction (cons (Tpointer val noattr) (cons threadInf nil)) Tvoid cc_default).

Notation isptrTy := (Tfunction (cons val nil) (Tint IBool Unsigned noattr) cc_default).
